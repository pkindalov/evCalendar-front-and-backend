...
require_once  APPROOT . '/helpers/PHPMailer/Exception.php';
require_once  APPROOT . '/helpers/PHPMailer/PHPMailer.php';
require_once  APPROOT . '/helpers/PHPMailer/SMTP.php';
