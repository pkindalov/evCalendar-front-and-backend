    ...
    <div class="nav-wrapper">
        <a href="<?php echo URLROOT; ?>" class="brand-logo">
            ...
            <?php if ((isset($data['todayEvents']) and $data['todayEvents'] > 0) ||
                ...
                <!--                <span>--><?php //echo $data['todayEvents'] == 0 ? count($data['upcomingEventsInHour']) : $data['todayEvents']; ?><!--</span>-->
                <?php echo SITENAME; ?>
                ...
                <span class="material-icons">
                  ...
                  <span class="material-icons">
                    calendar_today
                                    ...
                                    Upcoming... soon<span
                                            class="new badge"><?php echo count($data['upcomingEventsInHour']); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
                ...
                <div class="col s12 ">
                    <div class="row">
                        <div class="input-field col s8 red-text">
                            ...
                            <input type="text" placeholder="search" id="autocomplete-input-nav"
